...
## ffmpeg commands
- Обрезка
ffmpeg -i 2_сutted.mkv -ss 10:00 -c copy output.mkv

- Разбиение на две части
1. Первая часть
ffmpeg -i input.mkv -ss 00:00 -to 10:56 -c copy part1.mkv

2. Вторая часть
ffmpeg -i input.mkv -ss 10:56 -c copy part2.mkv

## 11.08
walksnail-osd-tool

repair file (untrunc - good - bad)
./untrunc ~/Videos/2026_08_10\ Испытания/AvatarG0011.mp4 ~/Videos/2026_08_10\ Испытания/corrypt/AvatarG0013.mp4
